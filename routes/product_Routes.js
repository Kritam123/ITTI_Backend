...
import { createNewProduct, createReview, getFilterProducts, getProductBySlugName } from "../controllers/product_controller.js";
...
productRoutes.post("/:productId/review/create",verifyJWT,createReview);
